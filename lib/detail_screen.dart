...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: Stack(
          children: [
            appImage('https://image.tmdb.org/t/p/original${widget.movie.poster}', size),
            moviePoster(size),
  ...
  Widget movieVideo(Size size) {
    return Container(
      ...
      // child: appImage('https://www.youtube.com/embed/${movie.poster}', size));//////////////////)
    );
  }
        ...
        children: [
          Expanded(
            ...
            child: Container(
                ...
                child: appImage('https://image.tmdb.org/t/p/original${widget.movie.poster}', size)),
          ),
  ...
  Widget moviePoster(Size size) {
    return BackdropFilter(
      ...
      child: Container(
        height: (1 / 3).sh,
        width: 1.sw,
        child: appImage('https://image.tmdb.org/t/p/original${widget.movie.backdrop}', size),
      ),
    );
  }
